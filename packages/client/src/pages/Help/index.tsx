...
const Help: React.FC = () => {
  return (
    <div className="help">
      ...
      <h5>Transferring Funds to Other Players, Student Finance and the Bank</h5>
      <p>
      ...
      <h5>Giving Student to a Player</h5>
      <p>
        To give student finance to a player, select the player in the dropdown under the "Give Student
        Finance" label and press "Give" to complete the transaction.
      </p>
